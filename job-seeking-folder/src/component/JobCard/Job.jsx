...
function JobCard(props) {
    ...
    return (
     ...
     <div className="flex justify-between items-center px-6 py-4 bg-zinc-300 rounded-md border-green shadow-lg hover:border-blue-500 hover:translate-y-1 hover:scale-103">
